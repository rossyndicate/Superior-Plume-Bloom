...
```{python}
training_ls8 = ee.FeatureCollection("projects/ee-ross-superior/assets/train-test/training_ls8")
testing_ls8 = ee.FeatureCollection("projects/ee-ross-superior/assets/train-test/testing_ls8")
```
...
#reformat and save
training_conf_l8['mission'] = 'Landsat 7'
training_conf_l8.reset_index(inplace = True)
training_conf_l8 = training_conf_l5.rename(columns = {'level_0': 'class'})  
