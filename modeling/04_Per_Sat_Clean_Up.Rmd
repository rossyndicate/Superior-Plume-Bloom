...
```{r}
write_csv(rs_subset, paste0('data/output/GTB_by_LS_mission_pass_v', v_date, '.csv'))
```
...
drive_upload(paste0('data/output/GTB_by_LS_mission_pass_v', v_date, '.csv'), as_id(upload_to$id[1]))
```
