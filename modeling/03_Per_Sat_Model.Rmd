...
ls_5_filt <- full_join(ls_5_filtered[[1]], ls_5_filtered[[2]]) %>% 
  full_join(., ls_5_filtered[[3]]) %>% 
  full_join(., ls_5_filtered[[4]]) %>% 
  full_join(., ls_5_filtered[[5]]) %>% 
  full_join(., ls_5_filtered[[6]]) %>% 
  distinct()
