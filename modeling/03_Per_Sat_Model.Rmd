...
export_summary_5 = (ee.batch.Export.table.toDrive(
  ...
  selectors = ['missDate', 'classified', 'cloud', 'openWater', 'lightNSSed','OSSed', 'dNSSed', 'other', 'area_ha'],
  description = 'quick_gradientTreeBoost_landsat_5_stack_v2023-07-25',
...
export_summary_7 = (ee.batch.Export.table.toDrive(
  ...
  selectors = ['missDate', 'classified', 'cloud', 'openWater', 'lightNSSed','OSSed', 'dNSSed', 'other', 'area_ha'],
  description = 'quick_gradientTreeBoost_landsat_7_stack_v2023-07-25',
  folder = 'eePlumB_classification',
  fileFormat = 'csv'))
...
export_summary_8 = (ee.batch.Export.table.toDrive(
  ...
  selectors = ['missDate', 'classified', 'cloud', 'openWater', 'lightNSSed','OSSed', 'dNSSed', 'other', 'area_ha'],
  description = 'quick_gradientTreeBoost_landsat_8_stack_v2023-07-25',
  folder = 'eePlumB_classification',
  fileFormat = 'csv'))
...
export_summary_9 = (ee.batch.Export.table.toDrive(
  ...
  selectors = ['missDate', 'classified', 'cloud', 'openWater', 'lightNSSed','OSSed', 'dNSSed', 'other', 'area_ha'],
  description = 'quick_gradientTreeBoost_landsat_9_stack_v2023-07-25',
  folder = 'eePlumB_classification',
  fileFormat = 'csv'))
...
export_summary_sen = (ee.batch.Export.table.toDrive(
  ...
  selectors = ['missDate', 'classified', 'cloud', 'openWater', 'lightNSSed','OSSed', 'dNSSed', 'other', 'area_ha'],
  description = 'quick_gradientTreeBoost_sen2_stack_v2023-07-25',
  folder = 'eePlumB_classification',
  fileFormat = 'csv'))
