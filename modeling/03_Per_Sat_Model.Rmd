...
### Indicate whether or not to send tasks to GEE

Just a quick toggle to be able to knit this script without necessarily sending
the tasks to GEE

```{python}
# These should either be True or False
export_summary = True
export_raster = True
```
...
training_conf_sen.to_csv('data/output/GTB_'+v_date+'_sen_training_confusion.csv', index = False)
...
confusion_sen.to_csv('data/output/GTB_'+v_date+'_sen_confusion.csv', index = False)
...
export_summary_5_aoi = (ee.batch.Export.table.toDrive(
  ...
  folder = 'eePlumB_classification_v2024-01-04',
  fileFormat = 'csv'))

if export_summary == True :
  export_summary_5_aoi.start()
else:
  print('Export for LS5 whole AOI toggled off.')
...
if export_summary == True :
  ...
  print('Export for LS5 no shoreline contamination AOI toggled off.')
...
if export_summary == True :
  ...
  print('Export for LS5 shoreline contamination AOI toggled off.')
...
if export_summary == True :
  ...
  print('Export for LS7 whole AOI toggled off.')
...
if export_summary == True :
  ...
  print('Export for LS7 no shoreline contamination AOI toggled off.')
...
if export_summary == True :
  ...
  print('Export for LS7 shoreline contamination AOI toggled off.')
```
...
if export_summary == True :
  ...
  print('Export for LS8 whole AOI toggled off.')
...
if export_summary == True :
  ...
  print('Export for LS8 no shoreline contamination AOI toggled off.')
...
if export_summary == True :
  ...
  print('Export for LS8 shoreline contamination AOI toggled off.')
```
...
if export_summary == True :
  ...
  print('Export for LS9 whole AOI toggled off.')
...
if export_summary == True :
  ...
  print('Export for LS9 no shoreline contamination AOI toggled off.')
...
if export_summary == True :
  ...
  print('Export for LS9 shoreline contamination AOI toggled off.')
```
...
if export_summary == True :
  ...
  print('Export for Sentinel-2 whole AOI toggled off.')
...
if export_summary == True :
  ...
  print('Export for Sentinel-2 no shoreline contamination AOI toggled off.')
...
if export_summary == True :
  ...
  print('Export for Sentinel-2 shoreline contamination AOI toggled off.')
...
First, we need to define a function to add one to the classification band:

```{python}
def add_one_to_classification(image):
  cl = image.select('classification')
  cl_plus_one = cl.add(1).rename('classification_plus1')
  return cl_plus_one
...
if export_raster == True:
  ...
  for d in range(date_length_5):
    ...
    image_new_class = (add_one_to_classification(image)
      .select('classification_plus1'))
  ...
  print('Raster export for LS5 turned off.')
...
if export_raster == True:
  ...
  print('Raster export turned off for Landsat 7')
...
if export_raster == True:
  ...
  print('Raster export turned off for Landsat 8')
...
if export_raster == True:
  ...
  print('Raster export turned off for Landsat 9')
...
if export_raster == True:
  ...
  print('Raster export turned off for Sentinel-2')
