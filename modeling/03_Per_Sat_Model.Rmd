...
Note, each image export takes 2-3 hours, resulting in a processing time of 
approximately 3 weeks. Do not run these chunks until you're ready to export 
final files.
...
for d in range(10,date_length_5):
