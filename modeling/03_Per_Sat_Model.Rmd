...
```{python}
area_ha = aoi_area.first().get('area_ha').getInfo()
...
def calcArea(image):
  ...
  a = area.first().set({'missDate': missDate, 'area_ha': area_ha})
  
  return ee.FeatureCollection(a)


total_area = aoi_area.first().get('area_ha').getInfo()
...
export_summary_5 = (ee.batch.Export.table.toDrive(
  ...
  selectors = ['missDate', 'classified', 'cloud', 'openWater', 'lightNSSed','OSSed', 'dNSSed', 'area_ha'],
  description = 'quick_gradientTreeBoost_landsat_5_stack_v' + v_date,
...
export_summary_7 = (ee.batch.Export.table.toDrive(
  ...
  selectors = ['missDate', 'classified', 'cloud', 'openWater', 'lightNSSed','OSSed', 'dNSSed', 'area_ha'],
  description = 'quick_gradientTreeBoost_landsat_7_stack_v' + v_date,
  folder = 'eePlumB_classification',
  fileFormat = 'csv'))
...
export_summary_8 = (ee.batch.Export.table.toDrive(
  ...
  selectors = ['missDate', 'classified', 'cloud', 'openWater', 'lightNSSed','OSSed', 'dNSSed', 'area_ha'],
  description = 'quick_gradientTreeBoost_landsat_8_stack_v' + v_date,
  folder = 'eePlumB_classification',
  fileFormat = 'csv'))
...
export_summary_9 = (ee.batch.Export.table.toDrive(
  ...
  selectors = ['missDate', 'classified', 'cloud', 'openWater', 'lightNSSed','OSSed', 'dNSSed', 'area_ha'],
  description = 'quick_gradientTreeBoost_landsat_9_stack_v' + v_date,
  folder = 'eePlumB_classification',
  fileFormat = 'csv'))
...
## get CRS info
img_crs_sen = newStack_sen.first().select('classification').projection()
...
allAreas_sen = newStack_sen.map(calcArea_sen)

## export to drive
export_summary_sen = (ee.batch.Export.table.toDrive(
  collection = allAreas_sen,
  selectors = ['missDate', 'classified', 'cloud', 'openWater', 'lightNSSed','OSSed', 'dNSSed', 'area_ha'],
  description = 'quick_gradientTreeBoost_sen2_stack_v' + v_date,
  folder = 'eePlumB_classification',
  fileFormat = 'csv'))

export_summary_sen.start()
