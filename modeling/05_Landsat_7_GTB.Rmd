...
```{python}
training_ls7 = ee.FeatureCollection("projects/ee-ross-superior/assets/train-test/training_ls7")
testing_ls7 = ee.FeatureCollection("projects/ee-ross-superior/assets/train-test/testing_ls7")
```
...
training_conf_l7 = training_conf_l5.rename(columns = {'level_0': 'class'})  
