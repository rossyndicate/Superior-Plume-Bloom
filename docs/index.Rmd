...
- If you were completing the validation workflow, check your labeled images against our expectations by ????. If you are happy with your results, you are ready to start labeling for real! Head to the `Selecting a mission-date for labeling` section to pick your own mission-date, and then start back at `How to label: Part 1`.
